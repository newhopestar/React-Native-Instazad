...
const index = () => {
  ...
  return (
    <TouchableOpacity activeOpacity={1} style={styles.navigationBar}>
      <TouchableOpacity onPress={() => navigation.navigate("CameraTab")} style={styles.btnBack}>
        <Icon name="camera" size={24} />
      </TouchableOpacity>
      <View style={styles.centerBar}>
        <Image style={styles.logo} source={require("../../assets/images/logo.png")} />
      </View>
      <TouchableOpacity onPress={() => navigation.navigate("Direct")} style={styles.btnMessenger}>
        <View>
          <Image
            style={{
              height: 24,
