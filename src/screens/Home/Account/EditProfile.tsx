  ...
  return (
    <SafeAreaView>
      <View style={styles.customNavigationBar}>
        ...
        />
        <TouchableOpacity disabled={updating} onPress={_onDone} style={styles.btnSave}>
          {!updating ? (
            <Image
              style={{
                width: 20,
      ...
      {showModal && (
        <TouchableOpacity activeOpacity={1} onPress={() => setShowModal(false)} style={styles.modalWraper}>
          <View
            style={{
              backgroundColor: "#fff",
              width: "90%",
          ...
          >
            <View style={styles.wrapper}>
              ...
              <View style={styles.infoFormWrapper}>
                ...
                <TouchableOpacity onPress={() => setInputFor(2)} activeOpacity={0.8} style={styles.infoItem}>
                  <Text
                    style={{
                      fontWeight: "600",
                      color: "#666",
                ...
                <TouchableOpacity onPress={() => setInputFor(3)} activeOpacity={0.8} style={styles.infoItem}>
                  <Text
                    style={{
                      fontWeight: "600",
                      color: "#666",
                ...
                <TouchableOpacity onPress={() => setInputFor(4)} activeOpacity={0.8} style={styles.infoItem}>
                  <Text
                    style={{
                      fontWeight: "600",
                      color: "#666",
                  ...
                  >
                    <Text>{user?.gender == 0 ? "Famale" : user?.gender === 1 ? "Male" : "Prefer Not to Say"}</Text>
                  </View>
                </TouchableOpacity>
              </View>
            </View>
