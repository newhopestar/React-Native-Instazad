      ...
      >
        <View style={styles.profileContainer}>
          ...
          <ScrollView
            ...
            refreshControl={<RefreshControl refreshing={refreshing} onRefresh={_onRefreshing} />}
            style={{
              width: "100%",
            }}
          >
            <TouchableOpacity activeOpacity={1} onPress={_onBackToMainScreen}>
              <View onLayout={_onSetHeaderHeight}>
                <View style={styles.infoWrapper}>
                  <TouchableOpacity onPress={() => navigate("CameraTab")} style={styles.avatarWrapper}>
                    <FastImage style={styles.mainAvatar} source={{ uri: user?.userInfo?.avatarURL }} />
                ...
                {highlights.length > 0 && <HighlightPreviewList showAdder={true} highlights={highlights} />}
              </View>
        ...
        <View style={styles.profileOptions}>
          ...
          <View style={styles.optionsWrapper}>
            <TouchableOpacity onPress={() => navigate("Archive")} activeOpacity={0.8} style={styles.optionItem}>
            ...
            <TouchableOpacity onPress={() => navigate("Saved")} activeOpacity={0.8} style={styles.optionItem}>
            ...
            <TouchableOpacity onPress={() => navigate("CloseFriends")} activeOpacity={0.8} style={styles.optionItem}>
            ...
            <TouchableOpacity onPress={() => navigate("DiscoverPeople")} activeOpacity={0.8} style={styles.optionItem}>
            ...
            <TouchableOpacity onPress={_onBackToMainScreen} activeOpacity={0.8} style={styles.optionItem}>
