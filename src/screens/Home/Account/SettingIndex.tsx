    ...
    <SafeAreaView style={{ backgroundColor: "#fff" }}>
      ...
      <View style={styles.container}>
        <ScrollView bounces={false}>
          ...
          <TouchableOpacity onPress={() => navigate("AddAccount")} activeOpacity={0.9} style={styles.settingItem}>
            <Text
              style={{
                fontSize: 16,
                color: "#318bfb",
          ...
          <TouchableOpacity onPress={() => navigate("Logout")} activeOpacity={0.9} style={styles.settingItem}>
            <Text
              style={{
                fontSize: 16,
                color: "#318bfb",
