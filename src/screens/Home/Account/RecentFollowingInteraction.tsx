        ...
        .then((rs) => {
          ...
          ref
            ...
            .then((rs) => {
              ...
              interactionList = Array.from(new Set(interactionList)).filter((usr) => usr !== username);
              const taskFollowings: Promise<UserInfo>[] = interactionList.map(async (userX) => {
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          ...
          >
            ...
            <TouchableOpacity onPress={_onRemove.bind(null, index)} style={styles.btnRemove}>
              <Text
                style={{
                  fontWeight: "500",
                }}
