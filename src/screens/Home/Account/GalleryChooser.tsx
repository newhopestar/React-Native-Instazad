      ...
      if (step === 1) {
        ...
        Promise.all(tasks).then(async (resultList) => {
          ...
          const postData: Post = {
            ...
            isVideo: false,
            permission: 1,
            notificationUsers: offComment ? [] : user?.username ? [user.username] : [],
            likes: [],
            source: resultList,
    ...
    <SafeAreaView style={styles.container}>
      {uploading && (
        ...
        >
          <View style={styles.uploadingContainer}>
            ...
            >
              {isChooseProfilePhoto ? "Uploading Photo..." : step === 1 ? "Processing Photos..." : "Posting..."}
            </Text>
          </View>
        </View>
      )}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {isChooseProfilePhoto ? (
                    <AvatarChooserMask maskColor="rgba(242,242,242,0.3)" width={SCREEN_WIDTH} height={SCREEN_WIDTH} />
                  ) : (
                    <Animated.View
                      style={{
                    ...
                    >
                      <ImageChooserMask maskColor="#fff" width={SCREEN_WIDTH} height={SCREEN_WIDTH} />
                    </Animated.View>
                  )}
                </View>
              </PanGestureHandler>
      ...
      {step === 2 && (
        ...
        >
          ...
          >
            <TouchableOpacity onPress={() => {}} activeOpacity={0.9} style={styles.postOptionItem}>
              <Text
                style={{
                  fontSize: 16,
                }}
            ...
            >
              ...
              <Text
                ...
                style={{
                  fontSize: 16,
                  color: (address.place_name || "").length > 0 ? "#318bfb" : "#000",
                  width: SCREEN_WIDTH - 30 - 30 - 30,
                }}
              >
                {(address.place_name || "").length > 0 ? address.place_name : "Add Location"}
              </Text>
              {(address.place_name || "").length > 0 && (
                <TouchableOpacity
                  onPress={() => {
          ...
          {showAdvancedSettings && (
            <>
              ...
              <View style={styles.settingWrapper}>
                ...
                >
                  <TouchableOpacity onPress={setWriteAltText.bind(null, !writeAltText)}>
                    <Text
                      style={{
                        fontSize: 16,
                      }}
                ...
                >
                  ...
                  reated for your photos or your can choose to write your own.
                </Text>
              </View>
            </>
          )}
