...
const EditHighlight = ({ route }: EditHighlightProps) => {
  ...
  const highlight = useSelector((state) => state.user.highlights?.find((x) => x.name === highlightName));
  ...
  useEffect(() => {
    const to = setTimeout(async () => {
      ...
      const fetchTasks: Promise<StoryProcessedImage>[] = superIds.map(async (superId) => {
    ...
    <React.Fragment>
      {showConfirmDelete && (
        ...
        >
          <View style={styles.confirmBox}>
            ...
            <TouchableOpacity onPress={_onConfirmDelete} style={styles.btnConfirm}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "500",
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <FlatList
            ...
            renderItem={({ item, index }) => (
              <TouchableOpacity onPress={() => _onSelectCover(item)} activeOpacity={0.8}>
        ...
        <View style={styles.coverWrapper}>
          <TouchableOpacity onPress={() => setShowCovers(true)} activeOpacity={0.8} style={styles.coverBorder}>
            <FastImage
              source={{
                uri: coverUri,
              }}
        ...
        >
          ...
          <TextInput value={name} onChangeText={setName} style={styles.nameInput} placeholder="Highlight" />
        </View>
        <View
          style={{
            backgroundColor: "#fff",
        ...
        >
          <View style={styles.navigationOptions}>
            <TouchableOpacity activeOpacity={0.8} onPress={() => _onChangeMode(1)} style={styles.optionItem}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "500",
            ...
            <TouchableOpacity activeOpacity={0.8} onPress={() => _onChangeMode(2)} style={styles.optionItem}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "500",
          ...
          >
            <FlatList
              ...
              style={styles.galleryWrapper}
              renderItem={({ item, index }) => (
                <TouchableOpacity onPress={() => _onSelectImage(item)} activeOpacity={0.8}>
                  <StoryArchiveItem {...{ item, index }} />
                  <View
                    style={{
                      position: "absolute",
            ...
            <FlatList
              ...
              style={styles.galleryWrapper}
              renderItem={({ item, index }) => (
                <TouchableOpacity onPress={() => _onSelectImage2(index)} activeOpacity={0.8}>
                  <StoryArchiveItem {...{ item, index }} />
                  <View
                    style={{
                      position: "absolute",
                      ...
                      alignItems: "center",
                      zIndex: 1,
                      backgroundColor: selectedIndexs.indexOf(index) > -1 ? "#318bfb" : "rgba(0,0,0,0.3)",
                    }}
                  >
