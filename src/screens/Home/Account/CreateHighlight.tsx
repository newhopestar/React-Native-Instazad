    ...
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <TouchableOpacity activeOpacity={0.8} onPress={() => _onSelectImage(index)}>
      ...
      {step === 2 && (
        ...
        >
          <TouchableOpacity onPress={() => setStep(3)} activeOpacity={0.8} style={styles.borderCover}>
            <FastImage
              source={{
      ...
      >
        <FlatList
          ...
          numColumns={3}
          renderItem={({ item, index }) => (
            <TouchableOpacity activeOpacity={0.8} onPress={() => _onSelectCover(item)}>
              <StoryArchiveItem {...{ index, item }} />
            </TouchableOpacity>
          )}
          keyExtractor={(_, index) => `${index}`}
