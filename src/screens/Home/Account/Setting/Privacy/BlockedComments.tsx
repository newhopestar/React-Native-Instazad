...
const BlockedComments = () => {
  ...
  const blockedComments = useSelector((state) => state.user.setting?.privacy?.comments?.blockUsers);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        style={{
          backgroundColor: "#fff",
          height: SCREEN_HEIGHT - STATUS_BAR_HEIGHT - getTabBarHeight() - 44 - 60,
        }}
        showsVerticalScrollIndicator={false}
        bounces={false}
      >
        {result.map((userx, index) => (
          <UserItem key={index} userx={userx} _onToggleBlock={_onToggleBlock} blockList={blockList} />
        ))}
        {result.length === 0 &&
        ...
        {result.length === 0 && blockList.length === 0 && (
          ...
          >
            ...
            >
              People won't be notified when you block them. Any new comments they make on your posts won't be visible to
              anyone but them.
            </Text>
          </View>
        )}
    ...
    <View style={styles.peopleItem}>
      ...
      >
        ...
        >
          ...
          <Text
            style={{
              width: SCREEN_WIDTH - 30 - 50 - 20 - blockList.indexOf(userx.username || "") > -1 ? 70 : 60,
            }}
            numberOfLines={1}
          >
            {userx.bio}
      ...
      <TouchableOpacity
        ...
        style={{
          ...styles.btnBlock,
          backgroundColor: blockList.indexOf(userx.username || "") > -1 ? "#ddd" : "#318bfb",
      ...
      >
        <Text
          style={{
            fontWeight: "bold",
            color: blockList.indexOf(userx.username || "") > -1 ? "#000" : "#fff",
          }}
        >
