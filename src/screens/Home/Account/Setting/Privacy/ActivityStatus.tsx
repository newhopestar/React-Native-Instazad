  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView bounces={false} showsVerticalScrollIndicator={false}>
        ...
        >
          Allow accounts you follow and anyone you message to see when you were last active on Instagram apps. When this
          is turned off, you won't be able to see the activity status of their accounts.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
