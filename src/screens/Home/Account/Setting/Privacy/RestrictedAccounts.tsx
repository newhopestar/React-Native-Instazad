  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        >
          ...
          >
            {result.map((userX, index) => (
              <UserItem restrictList={restrictedList} _onToggleRestrict={_onToggleRestrict} userX={userX} key={index} />
            ))}
          </ScrollView>
        </View>
      )}
      ...
      <ScrollView bounces={false} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity onPress={setSearching.bind(null, true)} activeOpacity={1} style={styles.mockInputSearch}>
          <View
            style={{
              width: 40,
              height: 40,
  ...
  return (
    <View style={styles.peopleItem}>
      ...
      >
        ...
        >
          {restrictList.indexOf(userX.username || "") < 0 ? "Restrict" : "Unrestrict"}
        </Text>
      </TouchableOpacity>
    </View>
  );
