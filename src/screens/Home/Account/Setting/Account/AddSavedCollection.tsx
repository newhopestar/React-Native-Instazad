...
const AddSavedCollection = () => {
  ...
  //Get bookmarks
  const collection = useSelector((state) => state.user.bookmarks?.find((x) => x.name === `All Posts`));
  ...
  return (
    <SafeAreaView style={styles.container}>
          ...
          >
            <Text
              style={{
                ...
                color: "#318bfb",
                opacity:
                  (step === 2 && collectionName.length === 0) || (step === 1 && selectedIndexs.length === 0) ? 0.5 : 1,
              }}
            >
              {step === 1 ? "Next" : "Add"}
            </Text>
      ...
      {step === 2 && (
        <KeyboardAvoidingView behavior="height" style={styles.collectionInfoWrapper}>
          <FastImage
            source={{
