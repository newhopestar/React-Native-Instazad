...
const EditSavedCollection = ({ route }: EditSavedCollectionProps) => {
  ...
  return (
    <React.Fragment>
      {mode === 3 && (
        <TouchableOpacity activeOpacity={1} onPress={() => setMode(1)} style={styles.backdrop}>
          <View style={styles.confirmBox}>
            ...
            <TouchableOpacity onPress={() => setMode(1)} style={styles.btnConfirm}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "500",
        ...
        {mode !== 2 && (
          <React.Fragment>
            ...
            <View>
              ...
              <TextInput placeholder="Collection Name" value={name} onChangeText={setName} style={styles.nameInput} />
              <Text
                style={{
                  margin: 15,
                  fontSize: 16,
