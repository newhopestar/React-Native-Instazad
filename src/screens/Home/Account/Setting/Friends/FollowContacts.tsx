              ...
              case RESULTS.GRANTED:
                ...
                Contacts.getAllWithoutPhotos((err, contacts) => {
                  if (err) {
                    ...
                    (async () => await dispatch(FollowContactsRequest(phoneList)))().then(() => {
                      setSyncing(false);
                      navigation.goBack();
                    });
                  }
    ...
    <View style={styles.container}>
      ...
      {!syncing && (
        <View style={styles.mainContainer}>
          ...
          >
            To help people connect on Instagram, you can choose to have your contacts periodically synced and stored on
            our servers. You pick which contacts to follow. Disconnect anytime to stop asyncing.
          </Text>
          <View style={styles.optionsWrapper}>
            <TouchableOpacity onPress={_onSyncContactsHandler} style={styles.optionItem}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "bold",
