...
const ForgotPassword = ({ navigation }: ForgotPasswordProps) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View>
        <NavigationBar title={sentReset ? "Access Account" : "Login Help"} callback={() => navigation.goBack()} />
      </View>
      {sentReset ? (
        <View style={styles.afterSentContainer}>
          ...
          <TouchableOpacity activeOpacity={0.8} style={styles.sendingDescription}>
            ...
            >
              An email has been sent to your account's email address. Please check your email to continue. If you are
              still having problems , please visit the{" "}
              <Text
                style={{
                  fontWeight: "500",
                }}
        ...
        <View style={styles.centerContainer}>
          <View>
            ...
            >
              Enter your Instagram username or the email or phone number linked to account.
            </Text>
          </View>
          <View style={styles.formWrapper}>
            ...
            <TouchableOpacity onPress={_checkExistUsername} activeOpacity={0.8} style={styles.btnNext}>
              {!loading && (
                <Text
                  style={{
                    fontWeight: "600",
