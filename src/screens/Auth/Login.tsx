...
const Login = (): JSX.Element => {
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.loginForm}>
          ...
          <View style={styles.textInputWrapper}>
            <TextInput
              ...
              style={styles.input}
            />
            <TouchableOpacity style={styles.hidePasswordIcon} onPress={_onPressToggleHidePassword}>
              {hidePassword ? (
      ...
      <TouchableOpacity onPress={_onPressRegister} activeOpacity={1} style={styles.registerWrapper}>
        <Text
          style={{
            textAlign: "center",
            fontSize: 12,
