    ...
    <SafeAreaView style={styles.container}>
                    ...
                    {currentTab === 1 && (
                      <View style={styles.usePhone}>
                        <View
                          style={{
                            ...styles.inputWrapper,
                            borderColor: formikProps.touched.phone && formikProps.errors.phone ? "red" : "#ddd",
                          }}
                        >
                    ...
                    {currentTab === 2 && (
                      <View style={styles.useEmail}>
                        <View
                          style={{
                            ...styles.inputWrapper,
                            borderColor: formikProps.touched.email && formikProps.errors.email ? "red" : "#ddd",
                          }}
                        >
                          <TextInput
                ...
                <View style={styles.step2FormWrapper}>
                  <View style={styles.formGroupWrapper}>
                    <View
                      style={{
                        ...styles.inputWrapper,
                        borderColor: formikProps.touched.fullname && formikProps.errors.fullname ? "red" : "#ddd",
                      }}
                    >
                      <TextInput
                        autoCorrect={false}
                      ...
                      <TouchableOpacity
                        onPress={() => formikProps.setFieldValue("fullname", "")}
                        style={styles.btnReset}
                      >
                        {formikProps.values.fullname.length > 0 && <Text>✕</Text>}
                      </TouchableOpacity>
                    </View>
                  ...
                  <View style={styles.formGroupWrapper}>
                    <View
                      style={{
                        ...styles.inputWrapper,
                        borderColor: formikProps.touched.password && formikProps.errors.password ? "red" : "#ddd",
                      }}
                    >
                      <TextInput
                    ...
                    <TouchableOpacity
                      ...
                      activeOpacity={1}
                      onPress={() => {
                        formikProps.setFieldValue("savePassword", !formikProps.values.savePassword);
                      }}
                    >
                      <View
                        style={{
                          ...styles.checkbox,
                          backgroundColor: formikProps.values.savePassword ? "#318bfb" : "#fff",
                          borderColor: formikProps.values.savePassword ? "#318bfb" : "#ddd",
                        }}
                      >
                        <Text
                          style={{
            ...
            >
              {(formikProps: FormikProps<RegisterFormValuesStep3>) => (
                <View style={styles.step3Wrapper}>
                  <View>
                    <Image style={styles.birthdayIcon} source={require("../../assets/images/rocket.png")} />
                  </View>
                  <Text
                    style={{
                      marginVertical: 15,
                  ...
                  <View style={styles.birthdayInputWrapper}>
                    <View style={styles.birthdayInput}>
                      <Text>
                        {MONTH_ALIAS[formikProps.values.month]} {formikProps.values.date}, {formikProps.values.year}{" "}
                      </Text>
                    ...
                    <View style={{ alignItems: "center" }}>
                      ...
                      >
                        Use your own birthday, even if this account is for a bussiness, a pet or something else.
                      </Text>
                    </View>
                  </View>
                  <TouchableOpacity
      ...
      {step === 2 && (
        <View style={styles.syncContactDescription}>
          ...
          >
            Your contacts will be periodically synced and stored on Instagram servers to help you and others find
            friends, and to help us provide a better service. To remove contact, go to Settings and disconnect.
            <Text
              style={{
                color: "#000",
              }}
      ...
      {step === 1 && (
        <TouchableOpacity onPress={() => navigation.navigate("Login")} activeOpacity={1} style={styles.btnLogin}>
          <Text
            style={{
              textAlign: "center",
              fontSize: 12,
