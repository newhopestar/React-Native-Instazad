...
export type WelcomePropsRouteParams = RegisterFormValuesStep3 & RegisterFormValuesStep2 & RegisterFormValuesStep1;
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.centerContainer}>
          ...
          <>
            <View style={styles.usernameInputWrapper}>
              ...
              <View style={styles.validIcon}>
                {usernameError ? <Text style={{ color: "red" }}>✕</Text> : <Text style={{ color: "green" }}>✓</Text>}
              </View>
            </View>
            {usernameError && (
              <Text
        ...
        <TouchableOpacity onPress={_onRegister} activeOpacity={0.8} style={styles.btnNext}>
          <Text
            style={{
              fontWeight: "600",
              color: "#fff",
        ...
        {!chagingUsername && (
          <TouchableOpacity onPress={_onClickChangeUsername} activeOpacity={0.8}>
            <Text
              style={{
                fontWeight: "600",
                color: "#318bfb",
    ...
    .then((snap) => {
      if (snap.size > 0) {
        ...
        if (setChagingUsername) {
          ...
          Alert.alert("Username has been already used", "Try to use another username", buttonGroup);
        }
