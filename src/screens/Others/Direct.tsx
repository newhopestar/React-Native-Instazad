    ...
    <SafeAreaView style={styles.container}>
      {!searching ? (
        ...
        <View style={styles.searchNavigationBar}>
          ...
          />
          <KeyboardAvoidingView behavior="height" style={styles.searchResultList}>
            <FlatList
              style={{
                height: "100%",
                marginBottom: 50,
      ...
      <View style={styles.mainContainer}>
        <TouchableOpacity onPress={_onSearching} activeOpacity={0.8} style={styles.searchBar}>
        ...
        <View>
          <FlatList
            ...
            data={messages}
            renderItem={({ item, index }) => <UserMessageItem {...{ item, index }} />}
            keyExtractor={(item, index) => `${index}`}
          />
        </View>
      </View>
...
export const UserMessageItem = React.memo(({ item }: UserMessageItemProps) => {
  ...
  return (
    <TouchableHighlight onPress={_onViewConversation} underlayColor="#ddd" style={styles.userContainer}>
      <>
        <View
          style={{
            flexDirection: "row",
