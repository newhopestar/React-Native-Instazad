      ...
      <PanGestureHandler onGestureEvent={_onGestureEventHandler} onHandlerStateChange={_onStateChangeHandler}>
        ...
        >
          ...
          {followType === 3 && (
            ...
            >
              <TouchableOpacity onPress={_onUnRequest} activeOpacity={0.9} style={styles.optionItem}>
                <Text
                  style={{
                    color: "red",
                    fontSize: 16,
          ...
          {followType === 1 && (
            ...
            >
              <TouchableOpacity onPress={_toggleCloseFriend} activeOpacity={0.9} style={styles.optionItem}>
                <Text
                  style={{
                    fontSize: 16,
                  }}
              ...
              <TouchableOpacity onPress={_onUnFollow} activeOpacity={0.9} style={styles.optionItem}>
                <Text
                  style={{
                    color: "red",
                    fontSize: 16,
