...
const ProfileOptions = ({ route }: ProfileOptionsProps) => {
  ...
  return (
    <>
      {confirmBlock && (
        <TouchableOpacity onPress={setConfirmBlock.bind(null, false)} activeOpacity={1} style={styles.backdrop}>
          <View style={styles.confirmBlock}>
            ...
            <TouchableOpacity onPress={setConfirmBlock.bind(null, false)} style={styles.btn}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "600",
      ...
      {confirmRestrict && (
        <TouchableOpacity onPress={setConfirmRestrict.bind(null, false)} activeOpacity={1} style={styles.backdrop}>
          <View style={styles.confirmBlock}>
            <Text
              style={{
                fontSize: 16,
            ...
            >
              ...
              >
                You'll control if others can see their new comments on your posts.You'll control if others can see their
            ...
            <TouchableOpacity onPress={setConfirmRestrict.bind(null, false)} style={styles.btn}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "600",
      ...
      >
        <View style={styles.mainOptions}>
          ...
          <View style={{ backgroundColor: "#000" }}>
            <TouchableOpacity onPress={_onBlock} activeOpacity={0.8} style={styles.optionItem}>
              <Text>Block</Text>
            </TouchableOpacity>
          </View>
          <View style={{ backgroundColor: "#000" }}>
            <TouchableOpacity onPress={_onRestrict} activeOpacity={0.8} style={styles.optionItem}>
              <Text>Restrict</Text>
            </TouchableOpacity>
          </View>
          <View style={{ backgroundColor: "#000" }}>
          ...
          <View style={{ backgroundColor: "#000" }}>
            <TouchableOpacity onPress={() => shareProfile(userX)} activeOpacity={0.8} style={styles.optionItem}>
