...
const StoryViewerOptions = ({ route }: StoryViewerOptionsProps) => {
  ...
  const hideStoryFrom = useSelector((state) => state.user.setting?.privacy?.story?.hideStoryFrom) || [];
  ...
  return (
    <React.Fragment>
      {showConfirmBlock && (
        <TouchableOpacity activeOpacity={1} onPress={() => setShowConfirmBlock(false)} style={styles.backdrop}>
          <View style={styles.confirmBox}>
            ...
            >
              They won't be able to find your profile, posts or story on Instagram. Instagram wont't let them know you
              blocked them.
            </Text>
            <TouchableOpacity onPress={_onConfirmBlock} style={styles.btnConfirm}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "500",
            ...
            <TouchableOpacity onPress={() => setShowConfirmBlock(false)} style={styles.btnConfirm}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "500",
      ...
      {showConfirmRemoveFollower && (
        <TouchableOpacity activeOpacity={1} onPress={() => setShowConfirmRemoveFollower(false)} style={styles.backdrop}>
          <View style={styles.confirmBox}>
            <FastImage
              source={{
            ...
            >
              Instagram won't tell to {username} they were removed from your followers.
            </Text>
            <TouchableOpacity onPress={_onConfirmRemoveFollower} style={styles.btnConfirm}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "500",
            ...
            <TouchableOpacity onPress={() => setShowConfirmRemoveFollower(false)} style={styles.btnConfirm}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "500",
      ...
      <SafeAreaView>
        ...
        <PanGestureHandler onGestureEvent={_onGestureEventHandler} onHandlerStateChange={_onStateChangeHandler}>
          ...
          >
            ...
            <View>
              <TouchableOpacity onPress={() => setShowConfirmBlock(true)} style={styles.optionItem}>
                <Text
                  style={{
                    fontSize: 16,
                    color: "red",
              ...
              <TouchableOpacity onPress={() => setShowConfirmRemoveFollower(true)} style={styles.optionItem}>
                <Text
                  style={{
                    fontSize: 16,
                  }}
              ...
              <TouchableOpacity onPress={_onHideYourStory} style={styles.optionItem}>
                <Text
                  style={{
                    fontSize: 16,
                  }}
