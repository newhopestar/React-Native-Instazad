...
const StorySeenList = ({ route }: StorySeenListProps) => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const fetchUserInfoTask: Promise<ProfileX>[] = filteredSeenList.map(async (usr) => {
  ...
  return (
    <React.Fragment>
      {showConfirmDelete && (
        <TouchableOpacity activeOpacity={1} onPress={() => setShowConfirmDelete(false)} style={styles.backdrop}>
          <View style={styles.confirmBox}>
            ...
            <TouchableOpacity onPress={() => setShowConfirmDelete(false)} style={styles.btnConfirm}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: "500",
      ...
      <View>
        ...
        >
          ...
          >
            <TouchableOpacity onPress={() => navigate("StoryPrivacy")} style={styles.btnOption}>
        ...
        >
          <View style={styles.optionsBar}>
            ...
            >
              <TouchableOpacity onPress={() => setShowConfirmDelete(true)} style={styles.btnOption}>
                <Image
                  style={{
                    height: 24,
                    width: 24,
          ...
          <View>
            ...
            <FlatList
              ...
              data={viewerInfos}
              renderItem={({ item }) => <ViewerItem setTargetMsgUsername={setTargetSendMsgUsername} user={item} />}
...
const ViewerItem = React.memo(({ user, setTargetMsgUsername }: ViewerItemProps) => {
  ...
  return (
    <TouchableOpacity onPress={_onViewProfile} style={styles.viewerItem}>
      ...
      >
        <TouchableOpacity onPress={_onShowViewerOptions} style={styles.btnViewerOption}>
          <Icon name="dots-vertical" size={24} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setTargetMsgUsername(`${user.username}`)} style={styles.btnViewerOption}>
          <Image
            style={{
              height: 20,
              width: 20,
