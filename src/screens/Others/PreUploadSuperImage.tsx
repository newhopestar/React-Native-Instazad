...
const PreUploadSuperImage = ({ route }: PreUploadSuperImageProps) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {!searching ? <NavigationBar title="Share" callback={_handlerGoBack} /> : <View style={styles.searchBar}></View>}
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.headerContainer}>
            <TouchableOpacity onPress={setSearching.bind(null, true)} style={styles.mockSearchBar}>
              <View
                style={{
                  height: 36,
                  width: 36,
            ...
            <TouchableOpacity style={styles.sendMethodItem}>
              ...
              <TouchableOpacity onPress={_onShareToStory.bind(null, storyPermissions.ALL)} style={styles.btnUpload}>
                <Text
                  style={{
                    fontWeight: "600",
                    color: "#fff",
