        ...
        {!!archivePosts.find((x) => x.uid === item.uid) ? (
          <>
            <View style={{ backgroundColor: "#000" }}>
              <TouchableOpacity onPress={_onRemoveArchive} activeOpacity={0.8} style={styles.optionItem}>
                <Text>Show on Profile</Text>
              </TouchableOpacity>
            </View>
            <View style={{ backgroundColor: "#000" }}>
              <TouchableOpacity onPress={_onRemoveBoth} activeOpacity={0.8} style={styles.optionItem}>
                <Text>Delete</Text>
              </TouchableOpacity>
            </View>
          </>
          ...
          <>
            ...
            <View style={{ backgroundColor: "#000" }}>
              <TouchableOpacity onPress={_toggleNotification} activeOpacity={0.8} style={styles.optionItem}>
                <Text>
                  Turn{" "}
                  {post.notificationUsers && post.notificationUsers?.indexOf(user?.username || "") > -1 ? "Off" : "On"}{" "}
                  Post Notifications
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={{ backgroundColor: "#000" }}>
              <TouchableOpacity onPress={() => sharePost(post)} activeOpacity={0.8} style={styles.optionItem}>
                <Text>Share to...</Text>
              </TouchableOpacity>
            </View>
            {user?.username === item.userId && (
              <View style={{ backgroundColor: "#000" }}>
                <TouchableOpacity onPress={_onArchive} activeOpacity={0.8} style={styles.optionItem}>
                  <Text>Archive</Text>
                </TouchableOpacity>
              </View>
            )}
            {user?.username !== item.userId && (
              <View style={{ backgroundColor: "#000" }}>
                <TouchableOpacity onPress={_onUnfollow} activeOpacity={0.8} style={styles.optionItem}>
                  <Text>Unfollow</Text>
                </TouchableOpacity>
              </View>
            )}
