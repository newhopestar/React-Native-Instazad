...
import { PhotoDetails } from "../screens/Home/Creator/DetailsCreators/PhotoDetailsCreator";
import { AuctionDetails } from "../screens/Home/Creator/DetailsCreators/AuctionDetailsCreator";
import { SaleDetails } from "../screens/Home/Creator/DetailsCreators/SaleDetailsCreator";
...
export type DetailsType = "auction" | "sale" | "photo";
export type PhotoPost = Post &
  PhotoDetails & {
    type: "photo";
  };
export type AuctionPost = Post &
  AuctionDetails & {
    type: "auction";
  };
export type SalePost = Post &
  SaleDetails & {
    type: "sale";
  };
